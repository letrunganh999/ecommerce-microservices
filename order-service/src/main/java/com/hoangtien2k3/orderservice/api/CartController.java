...
public class CartController {
    ...
    @GetMapping("/all")
    @PreAuthorize("hasAuthority('ADMIN') or hasAuthority('USER')")
    public Mono<ResponseEntity<Page<CartDto>>> findAll(
    ...
    public ResponseEntity<Mono<CartDto>> findById(
            @PathVariable("cartId")
    ...
    public Mono<ResponseEntity<CartDto>> save(
            @RequestBody
    ...
    public Mono<ResponseEntity<CartDto>> update(
            @RequestBody
            @NotNull(message = "Input must not be NULL")
            @Valid CartDto cartDto) {
    ...
    @PreAuthorize("hasAuthority('USER')")
    public Mono<ResponseEntity<Boolean>> deleteById(@PathVariable("cartId") String cartId) {
